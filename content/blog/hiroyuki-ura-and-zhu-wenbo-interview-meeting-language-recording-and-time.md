...
私は２つのやりかたで音素材を編集して録音していきました。まず１つは、２つの異なるカセットテーププレーヤーをミキサーにつないで、それぞれにループテープをセットして再生し、いったん音素材をmp3プレイヤーに落としました。ミキサーを通して音が入力／出力されることで、もともとのエンドレステープ上に録音されていた音素材とは違ったものになっていきます。それを、また再生して、サウンドカードに入れてからPC上で録音しました。
